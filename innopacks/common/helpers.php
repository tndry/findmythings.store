...
if (! function_exists('innoshop_brand_link')) {
    ...
    {
        if (is_admin()) {
            $default = '<a href="https://www.innoshop.com" class="ms-2" target="_blank">findmythings</a>';
        } else {
            $default = 'Powered By <a href="https://www.innoshop.com" class="ms-2" target="_blank">findmythings</a>';
        }
