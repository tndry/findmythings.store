...
use InnoShop\Front\Controllers\Account\VerificationController;
...
Route::get('/verify-email/{token}', [Account\VerificationController::class, 'verifyEmail'])->name('email.verify.manual');
...
Route::prefix('account')
    ...
    ->group(function () {
        ...
        //  Titipan
        Route::get('/titipan', [SubmissionController::class, 'userIndex'])->name('submissions.index');

        Route::get('/titipan/{submission}/edit', [SubmissionController::class, 'edit'])->name('submissions.edit');
        // Rute untuk menyimpan perubahan
        Route::put('/titipan/{submission}', [SubmissionController::class, 'update'])->name('submissions.update');

        Route::post('/titipan/{submission}/sold', [SubmissionController::class, 'markAsSold'])->name('submissions.mark_as_sold');
    });
