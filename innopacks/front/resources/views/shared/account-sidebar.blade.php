<div class="account-sidebar">
  ...
  <ul class="account-links">
    ...
    <li class="{{ request()->routeIs('*.account.submissions.index') ? 'active' : '' }}">
        <a href="{{ account_route('submissions.index') }}"><i class="bi bi-box-seam"></i>{{ front_trans('account.my_submissions') }}</a>
    </li>
