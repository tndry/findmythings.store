                ...
                <div class="col-12 col-lg-6">
                    <div class="product-info">
                        ...
                        <ul class="product-param">
                            ...
                            <li class="model {{ !($sku['model'] ?? false) ? 'd-none' : '' }}">
                                ...
                                <li class="category">
                                    ...
                                    <span class="value">
                                        @foreach ($product->categories as $category)
                                            <a href="{{ $category->url }}" class="text-dark">{{ $category->fallbackName() }}</a>{{ !$loop->last ? ', ' : '' }}
                                        @endforeach
                                    </span>
                                </li>
                            @endif
                        ...
                        @auth('customer')
                        @if(isset($product->submission) && $product->submission->submitter_whatsapp)
                            <div class="product-info-bottom mt-4">
                                ...
                                <a href="https://wa.me/{{ $wa_number }}?text={{ $message }}" target="_blank" class="btn btn-success btn-lg w-100">
                    ...
                    <div class="row gx-3 gx-lg-4">
                        @foreach ($related as $relatedItem)
                            <div class="col-6 col-md-4 col-lg-3">
                               @include('front::shared.product', ['product' => $relatedItem])
                            </div>
                        @endforeach
                    </div>
                </div>
