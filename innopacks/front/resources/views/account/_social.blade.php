...
@php
    // Cek apakah Google OAuth credentials tersedia melalui config
    $hasGoogleOAuth = !empty(config('services.google.client_id')) && !empty(config('services.google.client_secret'));
@endphp
