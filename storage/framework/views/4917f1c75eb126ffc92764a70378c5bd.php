...
<div class="d-flex align-items-center mb-3 mt-4 pagination-wrap">
  ...
  <div class="text-secondary">共<?php echo e($paginator->lastPage()); ?>页，</div>
  <div class="text-secondary">共<?php echo e($paginator->total()); ?>项</div>
</div>
<?php endif; ?>
<?php /**PATH C:\laragon\www\findmythings\innopacks/panel/resources/views/vendor/pagination/bootstrap-4.blade.php ENDPATH**/ ?>