<form action="<?php echo e(account_route('reviews.store')); ?>" method="POST">
        ...
        <?php if(isset($order)): ?>
          <div class="mb-3">
            <table class="table table-bordered table-striped table-response">
              <thead>
              <tr>
                <th><?php echo e(__('front/order.order_number')); ?></th>
                <th><?php echo e(__('front/order.product_image')); ?></th>
                <th><?php echo e(__('front/order.product_name')); ?></th>
                <th><?php echo e(__('front/order.product_spec')); ?></th>
              </tr>
              </thead>
              <tbody>
              <tr>
  ...
  <div class="modal-footer">
    <div class="col-12 text-end">
      <button type="submit" class="btn btn-primary submit_review"><?php echo e(__('front/product.submit_review')); ?></button>
    </div>
  </div>
</form>
<?php /**PATH C:\laragon\www\findmythings\innopacks\front\resources\views/shared/review.blade.php ENDPATH**/ ?>