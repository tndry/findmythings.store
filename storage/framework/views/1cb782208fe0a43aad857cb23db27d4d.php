...
<div class="offcanvas offcanvas-end" style="width: 400px;" tabindex="-1" id="miniCart" aria-labelledby="miniCartLabel">
  <div class="offcanvas-header border-bottom">
    <h5 class="offcanvas-title" id="miniCartLabel"><?php echo e(__('front/cart.cart')); ?></h5>
  ...
  <div class="offcanvas-body p-0 d-flex flex-column" style="height: calc(100vh - 60px);" v-cloak>
    ...
    <div v-if="isEmpty" class="text-center py-5">
      ...
      <h5><?php echo e(__('front/cart.empty_cart')); ?></h5>
      <a class="btn btn-primary mt-3" :href="urls.base_url"><?php echo e(__('front/cart.continue')); ?></a>
    </div>
      ...
      <div class="border-top p-3">
        <div class="d-flex align-items-center mb-3">
          <div class="form-check">
            ...
            <label class="form-check-label" for="selectAll"><?php echo e(__('front/cart.select_all')); ?></label>
          </div>
          <div class="ms-auto">
            <span class="fs-5"><?php echo e(__('front/cart.total')); ?></span>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\findmythings\innopacks\front\resources\views/components/mini-cart.blade.php ENDPATH**/ ?>