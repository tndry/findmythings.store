...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  getTranslate: function getTranslate() {
    $("#translate-button").click(function () {
      ...
      var text = input.val();
      axios.post("".concat(urls.base_url, "/translations/translate-text"), {
    ...
    $("#translate-html").click(function () {
      ...
      axios.post("".concat(urls.base_url, "/translations/translate-html"), {
...
/***/ "./innopacks/panel/resources/js/http.js":
/*!**********************************************!*\
  !*** ./innopacks/panel/resources/js/http.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./innopacks/panel/resources/js/product_selector.js":
/*!**********************************************************!*\
  !*** ./innopacks/panel/resources/js/product_selector.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/*!*********************************************!*\
  ...
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./http */ "./innopacks/panel/resources/js/http.js");
...
/* harmony import */ var _product_selector__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./product_selector */ "./innopacks/panel/resources/js/product_selector.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var Config = {
  base: ((_document$querySelect = document.querySelector("base")) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.href) || window.location.origin,
  editorLanguage: ((_document$querySelect2 = document.querySelector('meta[name="editor_language"]')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.content) || "zh_cn",
  apiToken: $('meta[name="api-token"]').attr("content") || $(window.parent.document).find('meta[name="api-token"]').attr("content"),
  csrfToken: $('meta[name="csrf-token"]').attr("content"),
  locale: $('html').attr("lang")
};
var Utils = {
  processFileManagerUrl: function processFileManagerUrl(file, config) {
    ...
    if (isOss) {
      ...
      return "https://".concat(cleanEndpoint, "/").concat(filePath.replace(/^\//, ""));
    }
    return config.baseUrl + "/" + filePath.replace(/^\//, "");
  },
  setupApiHeaders: function setupApiHeaders() {
...
var UI = {
  ...
  initTabNavigation: function initTabNavigation() {
    ...
    var tab = _common__WEBPACK_IMPORTED_MODULE_3__["default"].getQueryString("tab");
    if (tab) {
      var tabButton = $("button[data-bs-target=\"#".concat(tab, "\"]"));
      var tabLink = $("a[data-bs-target=\"#".concat(tab, "\"]"));
      if (tabButton.length) {
        tabButton[0].click();
  ...
  initHoverEffects: function initHoverEffects() {
  ...
  initAIGenerate: function initAIGenerate() {
    $(document).on("click", ".ai-generate", function (e) {
      // 找到当前按钮所在的 form-row
      var $row = $(this).closest(".form-row");
      // 在 row 内查找 input 或 textarea
      var $input = $row.find("input[data-column], textarea[data-column]");
      if ($input.length === 0) {
        layer.msg('未找到对应输入框', {
          icon: 2
        });
      ...
      axios.post(urls.ai_generate, formData, {}).then(function (res) {
        ...
        var _err$response;
        layer.msg(((_err$response = err.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'AI生成失败，请重试', {
          icon: 2
        });
      })["finally"](function () {
        layer.closeAll("loading");
...
var FileManager = {
  init: function init(callback) {
    ...
    layer.open({
      ...
      shade: 0.8,
      area: ["90%", "90%"],
      content: "/panel/file_manager/iframe?type=".concat(finalOptions.type, "&multiple=").concat(finalOptions.multiple ? "1" : "0")
    });
  }
};
var Editor = {
  ...
  setupEditor: function setupEditor(ed) {
    ed.ui.registry.addButton("toolbarImageButton", {
      ...
      onAction: function onAction() {
        FileManager.init(function (file) {
          var imageUrl = file.origin_url || file.url;
          if (imageUrl) {
            ed.insertContent("<img src=\"".concat(imageUrl, "\" class=\"img-fluid\" alt=\"").concat(file.name || '', "\" />"));
          }
        }, {
          type: "image",
          multiple: false
...
$(function () {
  ...
  window.inno.productSelectorIframe = _product_selector__WEBPACK_IMPORTED_MODULE_5__["default"].init;
